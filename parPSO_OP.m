function out = parPSO_OP(problem, parameters, data, size_init)
% out = parPSO_OP(problem, parameters, data, size_init)
...
parfor i=1:nPop        
    ...
    % evaluation
    x = [size_init, particle(i).position, rule_set_initial];
